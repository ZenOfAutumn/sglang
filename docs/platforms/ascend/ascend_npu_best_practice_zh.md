...
本节介绍 DeepSeek、Qwen 等主流 LLM 模型在昇腾 NPU 上的最佳实践数据。如果你遇到问题或有任何疑问,请[提交 issue](https://github.com/sgl-project/sglang/issues)。

## DeepSeek 系列模型

### 低时延

| 模型              | 硬件          | 卡数  | 部署模式          | 数据集    | TPOT | 量化         | 配置                                                                                       |
|-------------------|---------------|-------|-------------------|-----------|------|--------------|-------------------------------------------------------------------------------------------|
| Deepseek-R1       | Atlas 800I A3 | 32    | PD 分离           | 6K+1.6K   | 20ms | W8A8 INT8    | [最优配置](#deepseek-r1-6k-1_6k-20ms-on-a3-32-cards-disaggregation-mode)     |
| Deepseek-R1       | Atlas 800I A3 | 32    | PD 分离           | 3.9K+1K   | 20ms | W8A8 INT8    | [最优配置](#deepseek-r1-3_9k-1k-20ms-on-a3-32-cards-disaggregation-mode)     |
| Deepseek-R1       | Atlas 800I A3 | 32    | PD 分离           | 3.5K+1.5K | 20ms | W8A8 INT8    | [最优配置](#deepseek-r1-3_5k-1_5k-20ms-on-a3-32-cards-disaggregation-mode)   |
| Deepseek-R1       | Atlas 800I A3 | 32    | PD 分离           | 3.5K+1K   | 20ms | W8A8 INT8    | [最优配置](#deepseek-r1-3_5k-1k-20ms-on-a3-32-cards-disaggregation-mode)     |
| DeepSeek-V3.2     | Atlas 800I A3 | 32    | PD 分离           | 128K+1K   | 20ms | W8A8 INT8    | [最优配置](#deepseek-v32-128k-1k-20ms-on-a3-32-cards-disaggregation-mode)    |

### 高吞吐

| 模型        | 硬件          | 卡数  | 部署模式          | 数据集    | TPOT | 量化         | 配置                                                                                     |
|-------------|---------------|-------|-------------------|-----------|------|--------------|-----------------------------------------------------------------------------------------|
| Deepseek-R1 | Atlas 800I A3 | 32    | PD 分离           | 3.5K+1.5K | 50ms | W8A8 INT8    | [最优配置](#deepseek-r1-3_5k-1_5k-50ms-on-a3-32-cards-disaggregation-mode) |
| Deepseek-R1 | Atlas 800I A3 | 8     | PD 混合           | 2K+2K     | 50ms | W4A8 INT8    | [最优配置](#deepseek-r1-2k-2k-50ms-on-a3-8-cards-mixed-mode)               |
| Deepseek-R1 | Atlas 800I A3 | 16    | PD 分离           | 2K+2K     | 50ms | W4A8 INT8    | [最优配置](#deepseek-r1-2k-2k-50ms-on-a3-16-cards-disaggregation-mode)     |
| Deepseek-R1 | Atlas 800I A3 | 8     | PD 混合           | 3.5K+1.5K | 50ms | W4A8 INT8    | [最优配置](#deepseek-r1-3_5k-1_5k-50ms-on-a3-8-cards-mixed-mode)           |
| Deepseek-R1 | Atlas 800I A3 | 16    | PD 分离           | 3.5K+1.5K | 50ms | W4A8 INT8    | [最优配置](#deepseek-r1-3_5k-1_5k-50ms-on-a3-16-cards-disaggregation-mode) |
...
| 模型                           | 硬件          | 卡数  | 部署模式          | 数据集    | TPOT  | 量化         | 配置                                                                                                       |
|--------------------------------|---------------|-------|-------------------|-----------|-------|--------------|------------------------------------------------------------------------------------------------------------|
| Qwen3-235B-A22B                | Atlas 800I A3 | 24    | PD 分离           | 3.5K+1.5K | 50ms  | W8A8 INT8    | [最优配置](#qwen3-235b-a22b-3_5k-1_5k-50ms-on-a3-24-cards-disaggregation-mode)                |
...
| Qwen3-Coder-480B-A35B-Instruct | Atlas 800I A3 | 24    | PD 分离           | 3.5K+1.5K | 50ms  | W8A8 INT8    | [最优配置](#qwen3-coder-480b-a35b-instruct-3_5k-1_5k-50ms-on-a3-24-cards-disaggregation-mode) |
...
请参阅 [DeepSeek-R1 6K-1_6K 20ms on A3 32 Cards Disaggregation Mode](#deepseek-r1-6k-1_6k-20ms-on-a3-32-cards-disaggregation-mode)
