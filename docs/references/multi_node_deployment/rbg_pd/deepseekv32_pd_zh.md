# 基于 RBG 的 DeepSeekV32-Exp PD 部署
...
关于 RBG 的安装，请参考：https://github.com/sgl-project/rbg
...
2. 请确保镜像中的 sglang 代码已经合入了 [PR #10912](https://github.com/sgl-project/sglang/pull/10912) 的改动。
